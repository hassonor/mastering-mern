...
describe('Add', () => {
    ...
    describe('follower', () => {
        ...
        it('should call followerQueue addFollowerJob', async () => {
            ...
            // Mocking the user cache retrieval
            ...
            expect(spy).toHaveBeenCalledWith('addFollowerToDB', expect.objectContaining({
                keyOne: `${req.currentUser?.userId}`,
                keyTwo: '6064861bc25eaa5a5d2f9bf4',
                username: req.currentUser?.username
            }));

            // This ensures the followerDocumentId was passed, without caring about its specific value
            expect(spy.mock.calls[0][1]).toHaveProperty('followerDocumentId');
