...
describe('GetReactions', () => {
    ...
    describe('reactions', () => {
        it('should send correct json response if reactions exist in cache', async () => {
            ...
            jest.spyOn(ReactionCache.prototype, 'getReactionsFromCache').mockResolvedValue([reactionData]);
        ...
        it('should send correct json response if reactions exist in database', async () => {
            ...
            const res: Response = reactionMockResponse();
            jest.spyOn(ReactionCache.prototype, 'getReactionsFromCache').mockResolvedValue([]);
